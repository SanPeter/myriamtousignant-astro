...
import logoRacinesPlurielles from './images/Racines_Plurielles.png';

<ImageGrid 
  match="images/racines_plurielles-*" 
  sortOrder="asc" 
  rowHeight={200} 
  margins={10} 
...
<PartnerLink src={logoRacinesPlurielles} href='https://www.culturepourtous.ca/professionnels-de-la-culture/racines-plurielles/longueuil/' alt='Racines plurielles' /> 
