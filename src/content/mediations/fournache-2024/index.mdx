...
import logoImprimerie from './images/logotype_limprimerie.png';
import logoMtl from './images/Montreal_MHM_Noir_rosace rouge.png'
import { Image } from 'astro:assets';
import logoFousFr from './images/Logo-fous-francais-source.png';

<ImageGrid 
  match="images/fournache_*" 
  sortOrder="asc" 
  rowHeight={200} 
  margins={10} 
...
<PartnerLink src={logoImprimerie} href='https://limprimerie.art/' alt="L'imprimerie centre d'artistes" />

<Image 
  src={logoFousFr} 
  alt='Fous du français' 
  width={200} 
  height={200} 
  class="mt-4 mb-4"/>

<PartnerLink src={logoMtl} href='https://montreal.ca/mercier-hochelaga-maisonneuve' alt='Ville de Montréal - Arrondissement Mercier-Hochelaga-Maisonneuve' />
