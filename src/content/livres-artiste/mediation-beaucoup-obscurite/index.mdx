...
import DevelopmentCulturel from './images/entente-development-culturel.jpg';
import LogoMam from './images/logo-mam.png';
...
<PartnerLink src={LogoMam} href='https://www.mam.qc.ca' alt='MAM' />

<Image 
  src={DevelopmentCulturel} 
  alt={'Développement culturel'} 
  width={200} 
  height={200}
  style={`height: auto;`}
/>