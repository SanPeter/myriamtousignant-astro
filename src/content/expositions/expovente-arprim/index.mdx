...
import arprimLogo from './images/logo_signature_arprim.jpg';
import languesPenduesLogo from './images/lp-logo_couleur_800px-300x300.jpg';

<ImageGrid 
  match="images/expovente*" 
  sortOrder="asc" 
  rowHeight={200} 
  margins={10} 
...
<PartnerLink 
  href="https://languespendues.com/"
  src={languesPenduesLogo}
  alt="Langues Pendues"
/>