...
import logoLanguesPendues from './images/langues_pendues_logo_couleur-1170x658.webp';

<ImageGrid 
  match="images/intervention-poetique-*" 
  sortOrder="asc" 
  rowHeight={200} 
  margins={10} 
...
<PartnerLink src={logoLanguesPendues} href='https://languespendues.com/' alt='Langues pendues' />
